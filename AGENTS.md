...
2. Değişiklikleri PR (Pull Request) açarak DEĞİL, doğrudan `main` branch'ine push yaparak tamamla. Testler geçtiği ve kodun çalıştığından emin olduğun an, hiçbir onay beklemeden `main` dalına commit at.
