...
def render_single_analysis() -> None:
    """
    Tekil müşteri analizi sekmesini render eder.
    Kullanıcıdan müşteri parametrelerini alır ve risk analizi ile SHAP açıklamalarını gösterir.
    """
...
def render_what_if_simulator() -> None:
    """
    What-If Simülatörü sekmesini render eder.
    Müşteri parametrelerindeki değişikliklerin churn riskine etkisini simüle eder.
    """
...
def render_batch_analysis() -> None:
    """
    Toplu Analiz sekmesini render eder.
    CSV formatında yüklenen müşteri listesi üzerinden toplu risk ve finansal kayıp analizi yapar.
    """
...
# ==========================================
# 5. ANA PANEL (DASHBOARD) FONKSİYONU
# ==========================================
def main_dashboard() -> None:
    """
    Ana paneli render eder.
    Sol menüyü ve sekmeleri (Tekil Analiz, What-If Simülatörü, Toplu Analiz) oluşturur.
    """
